          ...
          children: [
            PageView.builder(
                ...
                itemBuilder: ((context, index) {
                  return Hero(
                    tag: widget.collectionType.collectionProducts[index].imagePath,
                    child: Container(
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage(widget.collectionType.collectionProducts[index].imagePath),
                              fit: BoxFit.cover)),
                    ),
                  );
                })),
              ...
              child: Column(
                children: [
                  AnimatedContainer(
                    ...
                    child: Center(
                        child: Text.rich(TextSpan(
                            text: "${widget.collectionType.collectionProducts[pageIndex].name}\n",
                  ...
                  Container(
                    ...
                    child: Container(
                        decoration:
                            const BoxDecoration(shape: BoxShape.circle, color: AppColors.accentColor)),
                  ),
                ],
              ),
            ),
                ...
                FloatingActionButton(
                  ...
                  onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => ProductDetailsPage(
                            product: widget.collectionType.collectionProducts[pageIndex],
                          ))),
                  child: const Icon(
                    Icons.add,
                    color: Colors.black,
